...
<!-- breadcrumb -->
<header>
	<title><%=currProduct.getProductName()%></title>
</header>
<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-5 p-b-30">
				<div class="p-r-50 p-t-5 p-lr-0-lg">
					...
					<%request.setAttribute("category", currProduct.getCategory());%>
					<c:choose>
						<c:when test="${ category.categoryId eq '4'}">
							<button class="stext-102 cl3 p-t-23" >
								<p style="text-decoration: underline">
									<a data-bs-toggle="modal" data-bs-target="#teesize">SIZE TABLE</a>
								</p>
								<div class="modal fade" id="teesize" tabindex="-1" aria-hidden="true" style="display: none; position: fixed; top: 90px; left: 0; width: 100%; height: 80vh;">
									<form class="modal-dialog modal-lg " style="min-height: 100vh; width: 50%;">
										<div class="modal-content" style="background-color: #f0f0f0fa">
											<img src="images/size/teesize.jpg">
										</div>
									</form>
								</div>
							</button>
						</c:when>
						<c:when test="${ category.categoryId eq '5'}">
							<button class="stext-102 cl3 p-t-23" >
								<p style="text-decoration: underline">
									<a data-bs-toggle="modal" data-bs-target="#shortsize">SIZE TABLE</a>
								</p>
								<div class="modal fade" id="shortsize" tabindex="-1" aria-hidden="true" style="display: none; position: fixed; top: 90px; left: 0; width: 100%; height: 80vh;">
									<form class="modal-dialog modal-lg " style="min-height: 100vh; width: 50%;">
										<div class="modal-content" style="background-color: #f0f0f0fa">
											<img src="images/size/jeanssize.jpg">
										</div>
									</form>
								</div>
							</button>
						</c:when>
						<c:when test="${ category.categoryId eq '6'}">
							<button class="stext-102 cl3 p-t-23" >
								<p style="text-decoration: underline">
									<a data-bs-toggle="modal" data-bs-target="#outerwearsize">SIZE TABLE</a>
								</p>
								<div class="modal fade" id="outerwearsize" tabindex="-1" aria-hidden="true" style="display: none; position: fixed; top: 90px; left: 0; width: 100%; height: 80vh;">
									<form class="modal-dialog modal-lg " style="min-height: 100vh; width: 50%;">
										<div class="modal-content" style="background-color: #f0f0f0fa">
											<img src="images/size/outerwearsize.jpg">
										</div>
									</form>
								</div>
							</button>
						</c:when>
						<c:when test="${ category.categoryId eq '7'}">
						</c:when>
