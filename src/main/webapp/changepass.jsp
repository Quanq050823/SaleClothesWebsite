              ...
              <div class="card mb-3">
                ...
                <div class="card-body userbox">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="description">Enter the new password for your email: ${useremail}</p>
                  </div>
                  <label for="recover-pass" class="icon-field"><i class="icon-login icon-envelope "></i></label>
                  <input type="text" size="30" name="pwd" placeholder="Password" id="recover-pass">
                  <label for="recover-repass" class="icon-field"><i class="icon-login icon-envelope "></i></label>
                  <input type="text" size="30" name="repwd" placeholder="Re-Enter password" id="recover-repass">
